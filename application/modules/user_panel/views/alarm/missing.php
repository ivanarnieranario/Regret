<div class="row px-5">
    <?php if ( !empty($alarms)): ?>
        <?php foreach ($alarms AS $key =>$alarm): ?>
            <div class="card mb-3">
                ...
                <div class="card-body row py-0 px-4">
                    ...
                    <div class="col-md-9 py-3">
                        <h4><span class="font-bold">Name: </span>
                            <?=$alarm->subject->fname.' '.$alarm->subject->mname.' '.$alarm->subject->lname?>
                        </h4>
                        <p><span class="font-bold">Age: </span><?=$alarm->subject->age?></p>
                        <p><span class="font-bold">Gender: </span> <?=$alarm->subject->gender?></p>
                        <a class="btn btn-primary" href="<?php $id=$alarm->subject->id; echo base_url("/user_panel/alarm/missing_details/$id") ?>">
                            View Detail
                        </a>
                    </div>
                </div>
